...
1. **Этап 1: Попытка реальной генерации**
...
3. **Этап 3: Переключение на стратегию "постоянного тока"**
